...
void LitWavesApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	static float _toggleLightTime = 1.f;
	static bool _turnOnLight = true;

	_elapsedTime += gt.DeltaTime();

	if (_elapsedTime >= _toggleLightTime)
	{
		_elapsedTime -= _toggleLightTime;
	...
	mMainPassCB.Lights[0].Strength = _turnOnLight ? XMFLOAT3{ 1.0f, 1.f, 1.f } : XMFLOAT3{ 0.f, 0.f, 0.f };
...
void LitWavesApp::BuildMaterials()
{
    ...
    water->FresnelR0 = XMFLOAT3(0.9f, 0.9f, 0.9f);
